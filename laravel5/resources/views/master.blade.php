    ...
    <body>
       ...
       <nav class="navbar navbar-default navbar-fixed-bottom">
           <footer class="container">
             <! please dont delete this > <marquee>created by <a href="https://www.facebook.com/denny.p.ls"> <span><i class="fa fa-facebook" style="color: #1da1f2"></i>@Dendi</span></a> <!--/ please dont delete this --></footer>
       </nav>
